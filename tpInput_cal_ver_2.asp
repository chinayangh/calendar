...
<span class="w2">分校</span>
<select name='Location'>
<%

city=Array("北京","上海","广州","深圳","成都","重庆","武汉","杭州","石家庄","西安")

    for(var i=0; i<city.length;i++)
    {
    Response.Write("<option value="+city[i]);
    Response.Write(" >");
    Response.Write(city[i]);
    Response.Write("</option>");
    }
    
%>
</select> 
<!--<input type='text' name='Location' maxlength='249' value='<%=vLocation%>'><--请输入相应分校城市名称--><BR><BR>
<span>外呼日期</span>
